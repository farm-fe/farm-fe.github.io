...
export default function BentoGridCard() {
  return (
    <BentoGrid className="max-w-full mx-auto md:auto-rows-[20rem] relative z-auto">
      {items.map((item, i) => (
        <BentoGridItem
          key={i}
          title={item.title}
...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={variants}
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2  items-center space-x-2 bg-soft dark:bg-soft"
      >
      ...
      <motion.div
        ...
        className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 w-3/4 ml-auto bg-soft dark:bg-soft"
      >
        <div className="w-full bg-gray-100 h-4 rounded-full dark:bg-neutral-900" />
        <div className="h-6 w-6 rounded-full bg-gradient-to-r from-pink-500 to-violet-500 flex-shrink-0" />
      </motion.div>
    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2  items-center space-x-2 bg-soft dark:bg-soft w-full h-4"
        ></motion.div>
      ))}
    </motion.div>
  );
...
const SkeletonFour = () => {
  ...
  return (
    ...
    >
      <motion.div
        variants={first}
        className="h-full w-1/3 rounded-2xl bg-soft p-4 dark:bg-soft dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center"
      >
        <img
        ...
        />
        <div className="sm:text-sm text-xs text-center font-semibold text-neutral-500 mt-4">
          Just code in Vanilla Javascript
        </div>
        <div className="border border-red-500 bg-red-100 dark:bg-red-900/20 text-red-600 text-xs rounded-full px-2 py-0.5 mt-4">
          Delusional
        </div>
      </motion.div>
      <motion.div className="h-full relative z-20 w-1/3 rounded-2xl bg-soft p-4 dark:bg-soft dark:border-white/[0.1] border border-neutral-200 flex flex-col items-center justify-center">
        <img
          src="https://pbs.twimg.com/profile_images/1417752099488636931/cs2R59eW_400x400.jpg"
          alt="avatar"
          height="100"
        ...
        <div className="border border-green-500 bg-green-100 dark:bg-green-900/20 text-green-600 text-xs rounded-full px-2 py-0.5 mt-4">
          Sensible
        </div>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <div className="border border-orange-500 bg-orange-100 dark:bg-orange-900/20 text-orange-600 text-xs rounded-full px-2 py-0.5 mt-4">
          Helpless
        </div>
      </motion.div>
    </motion.div>
