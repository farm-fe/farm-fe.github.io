...
<PackageManagerTabs command="add -D @farmfe/plugin-sass @farmfe/js-plugin-postcss" />
...
<PackageManagerTabs command="add @vitejs/plugin-vue @vitejs/plugin-vue-jsx -D" />
...
<PackageManagerTabs command="pnpm add unplugin-auto-import unplugin-vue-components -D" />
