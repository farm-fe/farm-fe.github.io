...
The nestjs project uses [farmup](https://github.com/aksharma27/farmup) to start and build the project. [Farmup](https://github.com/aksharma27/farmup) is built based on farm to simplify the way you run ts files in node js.
